...
#ifndef TPZELASTICITYPG2D_H
#define TPZELASTICITYPG2D_H
 ...
 */
class TPZElasticityPG2D : public TPZMatCombinedSpacesT<STATE>, TPZMatErrorCombinedSpaces<STATE>, public TPZElasticity2D
{
...
public :
	 ...
	 */
	TPZElasticityPG2D(int id, STATE E, STATE nu, STATE fx, STATE fy, int planestress = 1) :
    TPZElasticity2D(id,E,nu,fx,fy,planestress)
    {
        
    }
    
    TPZElasticityPG2D(int id) : TPZElasticity2D(id) {}
    
    TPZElasticityPG2D() : TPZElasticity2D(){}

	/** @brief Returns the material name*/
	std::string Name()  const override { return "TPZElasticityPG2D"; }
